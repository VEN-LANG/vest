...
export class CarbonInterval {
  ...
  static years(n: number): CarbonInterval {
    return new CarbonInterval({ years: n });
  }
  static months(n: number): CarbonInterval {
    return new CarbonInterval({ months: n });
  }
  static weeks(n: number): CarbonInterval {
    return new CarbonInterval({ weeks: n });
  }
  static days(n: number): CarbonInterval {
    return new CarbonInterval({ days: n });
  }
  static hours(n: number): CarbonInterval {
    return new CarbonInterval({ hours: n });
  }
  static minutes(n: number): CarbonInterval {
    return new CarbonInterval({ minutes: n });
  }
  static seconds(n: number): CarbonInterval {
    return new CarbonInterval({ seconds: n });
  }
